...
import com.Object_Repository.Insert_ProductPage;

public class ChangeStatusOfAnOrderedProductTest2 {
...
//		driver.findElement(By.name("submit")).click();
	...
	//	driver.findElement(By.name("submit")).click();
		...
		Insert_ProductPage insertObj=new Insert_ProductPage(driver);
